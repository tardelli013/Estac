 ...
 * @author: tardelli
 * 
 *          CLASSE QUE VAI REALIZAR A PERSISTÊNCIA DO NOSSO OBJETO UsuarioModel
 *          NO BANCO DE DADOS.
 * 
 * 
 */
...
public class UsuarioRepository {
	 ...
	 *                     estão sendo manipuladas pelo EntityManager
	 * 
	 * 
	 ...
	 * 
	 *            O JPA exige um contexto de transação para realizar as
	 *            alterações, por isso vamos usar a
	 *            anotação @javax.transaction.Transactional
	 * 
	 */
